...
public class ServerActivity extends Activity {
    ...
    private class getConnectionString {
        private void GetAppDetails() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://raw.githubusercontent.com/gayanvoice/gayankuruppu.github.io/source-json/appdetails.json", new Response.Listener<String>() {
                @Override
        ...
        private void GetFileDetails() {
            ...
            RequestQueue queue = Volley.newRequestQueue(ServerActivity.this);
            queue.getCache().clear();
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://raw.githubusercontent.com/gayanvoice/gayankuruppu.github.io/source-json/filedetails.json", new Response.Listener<String>() {
                @Override
                public void onResponse(String Response) {
                ...
                ll_item.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            Editor.apply();
                            Application.getInstance().hasFile = true;
                            Application.getInstance().abortConnection = true;
                        } catch (Exception e) {
                            Bundle params = new Bundle();
                            params.putString("device_id", Application.getInstance().device_id);
