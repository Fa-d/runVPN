...
public class ContactActivity extends Activity {
    ...
    class SendContactLog extends Thread {
        ...
        public void run() {
            ...
            try {
                str_post = URLEncoder.encode("ip", "UTF-8") + "=" + URLEncoder.encode(str_ipv4, "UTF-8") + "&" + URLEncoder.encode("advertise", "UTF-8") + "=" + URLEncoder.encode(advertise, "UTF-8") + "&" + URLEncoder.encode("speed", "UTF-8") + "=" + URLEncoder.encode(speed, "UTF-8") + "&" + URLEncoder.encode("connecting", "UTF-8") + "=" + URLEncoder.encode(connecting, "UTF-8") + "&" + URLEncoder.encode("working", "UTF-8") + "=" + URLEncoder.encode(working, "UTF-8") + "&" + URLEncoder.encode("crashed", "UTF-8") + "=" + URLEncoder.encode(crashed, "UTF-8") + "&" + URLEncoder.encode("other", "UTF-8") + "=" + URLEncoder.encode(other, "UTF-8") + "&" + URLEncoder.encode("email", "UTF-8") + "=" + URLEncoder.encode(email, "UTF-8");
